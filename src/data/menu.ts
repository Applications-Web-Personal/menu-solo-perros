...
export const hamburguesas: MenuItem[] = [
  {
    ...
    name: "Tradicional",
    description:
      "Carne mixta de res y cerdo, jamón, queso, tomate, lechuga, maíz tierno, champiñones, ripio, cebolla caramelizada y salsas al gusto.",
    price: 13000,
    image:
      "https://images.unsplash.com/photo-1568901346375-23c9450c58cd?w=600&h=400&fit=crop&crop=center",
  },
  ...
  },
  {
    ...
    name: "Ranchera",
    description:
      "Carne mixta de res y cerdo, chorizo, tocineta, jamón, queso, jalapeños, tomate, lechuga, maíz tierno, champiñones, ripio, cebolla caramelizada y salsas al gusto.",
    price: 15000,
    image:
  ...
  },
  {
    ...
    name: "Doble Carne",
    description:
      "Dos porciones de carne mixta de res y cerdo, jamón, queso, tomate, lechuga, maíz tierno, champiñones, ripio, cebolla caramelizada y salsas al gusto.",
    price: 18000,
    image:
...
export const adicionalesPago: AdicionalPago[] = [
  { name: "Carne mixta", detail: "De res y cerdo", price: 6000 },
  { name: "Filete de pollo", detail: "A la plancha", price: 6000 },
  { name: "Salchicha americana", price: 5000 },
  { name: "Tocineta", price: 2000 },
  { name: "Queso", price: 1000 },
  { name: "Porcion papa amarilla o francesa", price: 6000 },
];
...
export const bebidas: BebidaItem[] = [
  {
    name: "Jugo HIT",
    sizes: [
      { label: "Mediano", price: 4000 },
      { label: "Familiar", price: 7000 },
    ],
  },
  {
    name: "Gaseosa",
    sizes: [
      { label: "Pequeña", price: 2500 },
      { label: "Familiar", price: 7000 },
    ],
  },
  {
    name: "Agua en botella",
    sizes: [{ label: "Personal", price: 2500 }],
  },
  {
    name: "Refajo",
    sizes: [{ label: "Personal", price: 3500 }],
  },
];
